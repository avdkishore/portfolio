...
export default function ExperienceCard({ cardInfo, isDark }) {
  ...
  return (
    <a href={cardInfo.link} target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
      <div className={isDark ? "experience-card-dark":"experience-card"}>
        <div style={{background: rgb(colorArrays) }} className="experience-banner">
          ...
          <div>
            <img crossOrigin={"anonymous"} style={cardInfo.iconStyles} className="experience-roundedimg"  ref={imgRef}src={cardInfo.companylogo} alt={cardInfo.company} onLoad={() => getColorArrays()}/>
          </div>
        </div>
